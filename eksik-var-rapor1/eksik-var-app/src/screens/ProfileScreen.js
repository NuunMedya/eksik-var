  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: C.chalk }} contentContainerStyle={{ paddingBottom: 120 }}>
      <View style={st.header}>
        ...
        {user.mvpCount > 0 && (
          <View style={{ flexDirection: "row", alignItems: "center", gap: 4, marginTop: 6, backgroundColor: "rgba(245,179,1,0.18)", borderRadius: 999, paddingHorizontal: 10, paddingVertical: 4 }}>
