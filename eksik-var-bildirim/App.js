...
import { SEED_EVENTS, SEED_CHATS, SEED_APPS, ORGS, DEFAULT_SETTINGS, contactRules, genMembers, memberFromOrg, relAfterShow, relAfterNoShow, fmtEventDate, addDays, GUNLER_UZUN, buildShareText, buildInviteText, SEED_NOTIFS, nowTime, uid } from "./src/data";
...
export default function App() {
  ...
  const openNotif = (n) => {
    ...
    if (d.rate) { setTab("profile"); setView({ name: "rate" }); return; }
