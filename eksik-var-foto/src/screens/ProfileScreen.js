...
import { Stars, AvatarPicker } from "../components";
import { chooseAvatar } from "../avatar";

export default function ProfileScreen({ user, pendingRate, onRate, onLogout, onSettings, onInvite, onAvatar, settings = DEFAULT_SETTINGS }) {
  return (
