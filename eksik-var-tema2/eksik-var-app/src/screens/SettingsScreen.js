    ...
    <View style={{ flex: 1, backgroundColor: C.chalk }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 18, paddingBottom: 60 }}>
        ...
        <View style={[st.card, { padding: 14 }]}>
          ...
          <TextInput value={iban} onChangeText={(v) => setIban(formatIban(v))} placeholder={t("TR00 0000 0000 0000 0000 0000 00")} placeholderTextColor={C.placeholder} autoCapitalize="characters" style={st.input} />
          <TextInput value={holder} onChangeText={setHolder} placeholder={t("Hesap sahibi adı")} placeholderTextColor={C.placeholder} style={[st.input, { marginTop: 8 }]} />
