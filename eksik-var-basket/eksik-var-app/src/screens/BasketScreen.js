...
export default function BasketScreen({ onBack }) {
  ...
  const sut = () => {
    ...
    Animated.timing(topY, { toValue: -238, duration: UCUS, easing: Easing.out(Easing.quad), useNativeDriver: true }).start(() => {
      if (girdi) {
        ...
        Animated.sequence([
          Animated.timing(topY, { toValue: -200, duration: 120, useNativeDriver: true }),
