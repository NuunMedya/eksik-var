...
/* ---------- sohbetler ---------- */
const CHAT_COLS = "id, type, event_id, series_id, name, created_at, pinned_message_id, pinned:messages!conversations_pinned_message_id_fkey(id, content, image_url), conversation_members(user_id, role, is_muted, archived, hidden_at, last_read_message_id, users(" + USER_COLS + ")), messages!messages_conversation_id_fkey(id, sender_id, type, content, image_url, created_at, poll_id, reply_to_id, users!messages_sender_id_fkey(full_name), message_reactions(user_id, emoji))";
