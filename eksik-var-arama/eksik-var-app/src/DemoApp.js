...
import { C } from "./theme";
import { SEED_EVENTS, SEED_CHATS, SEED_APPS, ORGS, DEFAULT_SETTINGS, contactRules, genMembers, memberFromOrg, relAfterShow, relAfterNoShow, fmtEventDate, addDays, GUNLER_UZUN, buildShareText, buildInviteText, SEED_NOTIFS, REPORT_REASONS, applyRating, hoursUntil, commentsFor, nowTime, uid } from "./data";
...
export default function DemoApp() {
        ...
        <SafeAreaView style={{ flex: 1 }}>
          <AuthScreen
            ...
            onVerify={async (code, u) => {
              ...
              setAuthError(null);
              setUser({ ...u, name: u.name || "Emre Kaya", username: u.username || "emre_k", verified: true,
  ...
  const hideTabs = ["chat", "create", "settings", "groupInfo", "attendance", "notifications", "rate", "blocked", "profile"].includes(view.name) || !!activeEvent || !!call;
