        ...
        <View style={{ flex: 1, backgroundColor: C.chalk }}>
          ...
          {tab === "search" && !ustEkran && (
            <SearchScreen onSearchUsers={searchUsers} onSearchEvents={searchEvents} suggestions={suggestions}
              ...
              posts={posts} onLikePost={likePost} onDeletePost={removePost} onCompose={() => Alert.alert("\u2795 " + t("Paylaş"), t("Ne paylaşmak istersin?"), [
                { text: "\u{1F4F8} " + t("Fotoğraf / yazı paylaş"), onPress: () => setComposer(true) },
                { text: "\u{1F3AF} " + t("Vitrin gönderisi (transfer kartı)"), onPress: vitrinAtolyeAc },
                { text: t("Vazgeç"), style: "cancel" },
              ])} onOfferPost={teklifGonder} />
          )}
