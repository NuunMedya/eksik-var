...
export default function SearchScreen({ onSearchUsers, onSearchEvents, suggestions = [], recent = [], onAddRecent, onOpenUser, onOpenEvent, posts = [], onLikePost = () => {}, onDeletePost = null, onCompose = () => {}, onOfferPost = null, onMessagePost = null, onCommentsPost = null, onEditPost = null, onArchivePost = null, cityName = "" }) {
            ...
            <View>
              ...
              {segment === "kisiler" && (
                <View style={{ marginTop: recent.length || suggestions.length ? 18 : 0 }}>
                  ...
                  {(() => { const gp = posts.filter((p) => postIlce === "Tümü" || p.district === postIlce); return gp.length === 0 ? (
                    <View style={st.hint}>
                    ...
                    <PostCard key={p.id} p={p} onLike={onLikePost} onDelete={onDeletePost} onOffer={onOfferPost} onMessage={onMessagePost}
