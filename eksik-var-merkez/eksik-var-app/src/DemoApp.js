...
export default function DemoApp() {
  ...
  const hideTabs = ["chat", "create", "settings", "groupInfo", "attendance", "notifications", "rate", "blocked", "profile", "lineup", "editProfile", "penalti", "kadroDene"].includes(view.name) || !!activeEvent || !!call;
