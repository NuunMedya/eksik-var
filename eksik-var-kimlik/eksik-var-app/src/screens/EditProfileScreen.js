...
export default function EditProfileScreen({
  ...
  const [kim, setKim] = useState({ favCats: user.favCats || [], positions: user.positions || [] });
      ...
      <ScrollView contentContainerStyle={{ padding: 18, paddingBottom: 130 }} keyboardShouldPersistTaps="handled">
        ...
        {bolum !== "vitrin" && onSaveIdentity && (
          <Sec icon="🎯" title={t("BRANŞIN & MEVKİLERİN")}>
            ...
            <TouchableOpacity onPress={() => onSaveIdentity(kim)}
              style={{ flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6, backgroundColor: C.kit, borderRadius: 12, paddingVertical: 12, marginTop: 4 }}>
              <Text style={{ fontSize: 14 }}>💾</Text>
              <Text style={{ color: "#fff", fontWeight: "900", fontSize: 14 }}>{t("Kaydet")}</Text>
            </TouchableOpacity>
          </Sec>
        )}
