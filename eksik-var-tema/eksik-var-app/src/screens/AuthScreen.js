            ...
            <>
              ...
              {mode === "register" && (
                <>
                  ...
                  <Field label={t("auth.name")}><Input placeholder="Emre Kaya" value={f.name} onChangeText={set("name")} /></Field>
                  <Field label={t("auth.username")}><Input placeholder="emre_k" autoCapitalize="none" value={f.username} onChangeText={set("username")} /></Field>
