...
import { C } from "../theme";
import { MY_COMMENTS, MY_ATTENDANCE, MODE_LABEL, DEFAULT_SETTINGS, POSITIONS, CATEGORIES } from "../data";
import { Stars, AvatarPicker, EksikBadge, Chip } from "../components";
import { chooseAvatar } from "../avatar";

export default function ProfileScreen({ user, pendingRate, onRate, onLogout, onSettings, onInvite, onAvatar, settings = DEFAULT_SETTINGS, events = [], onOpenEvent = () => {}, onPositionsChange = () => {} }) {
