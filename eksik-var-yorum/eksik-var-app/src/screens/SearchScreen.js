...
export default function SearchScreen({ onSearchUsers, onSearchEvents, suggestions = [], recent = [], onAddRecent, onOpenUser, onOpenEvent, posts = [], onLikePost = () => {}, onDeletePost = null, onCompose = () => {}, onOfferPost = null, onCommentsPost = null }) {
