...
export const ORGS = {
  ali:    { id: "ali",    name: "Ali Yılmaz",    username: "ali_kaptan", rating: 4.8, count: 34, rel: 96, joined: 48, noShow: 2,
  ...
  murat:  { id: "murat",  name: "Murat Şahin",   username: "murat07",    rating: 4.2, count: 9,  rel: 78, joined: 7, noShow: 2,
...
export const SEED_EVENTS = [
  {
    ...
    guests: [{ id: "g3", name: "Hasan Kara", available: true, attendance: "bekleniyor", payment: "bekliyor" }],
...
export const memberFromOrg = (o, role = "uye", via = "ekip") =>
  ({ id: o.id, name: o.name, username: o.username, rating: o.rating, count: o.count, rel: o.rel, joined: o.joined, noShow: o.noShow, role, via });
...
export const NOTIF_META = {
  ...
  varmisin:   { icon: "hand-right",          color: C.pitch,   bg: C.pitchSoft },
  mvp:        { icon: "trophy",              color: "#C48A00", bg: "#FFF6D6" },
  odeme:      { icon: "cash",                color: C.turf,    bg: C.pitchSoft },
  yakin:      { icon: "location",            color: C.kit,     bg: C.kitSoft },
...
export const formatLabel = (cat, id) => { const f = formatInfo(cat, id); return f ? f.label : id || ""; };
