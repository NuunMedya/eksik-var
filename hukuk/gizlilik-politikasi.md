...
- Hesap bilgileri: ad soyad, kullanıcı adı, cep telefonu numarası (kayıt ve girişte SMS koduyla doğrulanır; şifre yoktur), isteğe bağlı e-posta, profil fotoğrafı, kısa tanıtım, seviye, mevkiler, takım adı.
- Ödeme bilgileri (yalnızca organizatörler, isteğe bağlı): IBAN ve hesap sahibi adı. Yalnızca siz görürsünüz; "IBAN'ı gruba gönder" dediğinizde seçtiğiniz grup sohbetine iletilir. Para uygulamadan geçmez.
- Uygulamasız oyuncular: organizatörün eklediği ekip arkadaşlarının adı (isteğe bağlı telefon özeti); yoklama ve ödeme takibi için.
- Maç verileri: skor, gol/asist, maçın oyuncusu oyları, "sahadayım" beyanı, anket cevapları, kura sonuçları.
- Cihaz izinleri (isteğe bağlı, her biri kapatılabilir): takvim (maçı takvime eklemek için), fotoğraflar (profil ve sohbet fotoğrafı), bildirimler. Konumunuz alınmaz; ilçe bilgisini siz seçersiniz.
