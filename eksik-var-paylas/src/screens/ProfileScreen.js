...
import { C } from "../theme";
import { MY_COMMENTS, MY_ATTENDANCE, MODE_LABEL, DEFAULT_SETTINGS, initials } from "../data";
import { Stars } from "../components";

export default function ProfileScreen({ user, pendingRate, onRate, onLogout, onSettings, onInvite, settings = DEFAULT_SETTINGS }) {
  return (
