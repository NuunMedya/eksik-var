...
const USER_COLS = "id, full_name, username, bio, skill_level, avatar_url, rating_avg, rating_count, reliability_pct, events_joined, events_organized, no_show_count, city_id, district_id, positions, fav_cat, fav_cats, team_name, mvp_count, is_verified, status, status_reason, suspended_until, contact_mode, contact_scope, quiet_enabled, quiet_start, quiet_end, notif_basvuru, notif_mesaj, notif_hatirlatma, notif_yakin, cities(name), districts(name)";
...
export function mapUser(u) {
  ...
  return {
    ...
    positions: u.positions || [], favCat: u.fav_cat || null, favCats: Array.isArray(u.fav_cats) ? u.fav_cats : [], teamName: u.team_name || null, mvpCount: u.mvp_count || 0,
