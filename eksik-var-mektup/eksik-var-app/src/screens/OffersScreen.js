    ...
    <View style={st.kart}>
      ...
      {o.status === "bekliyor" && (
        <View style={{ flexDirection: "row", gap: 8, marginTop: 10 }}>
          {sekme === "gelen" ? (
            <>
              <TouchableOpacity onPress={() => onDecide(o.id, "kabul", o.kisiId || o.fromId || o.from_user)} style={[st.btn, { backgroundColor: C.pitch }]}>
                <Text style={st.btnText}>✅ {t("Kabul et")}</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => onDecide(o.id, "ret", null)} style={[st.btn, { backgroundColor: C.chalk }]}>
