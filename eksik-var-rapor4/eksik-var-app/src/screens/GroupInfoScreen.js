...
/* ---------- grup bilgisi ekranı ---------- */
export default function GroupInfoScreen({ chat, event, me, onBack, onOpenEvent, onSelectMember, onLineup, guests = [], onMute = null }) {
...
const st = StyleSheet.create({
  ...
  lineupBtn: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "#fff", borderRadius: 16, padding: 12, marginTop: 12, borderWidth: 1, borderColor: C.line },
