...
export default function TennisScreen({ onBack }) {
  ...
  const segmentOynat = useCallback(() => {
    ...
    const cizgi = h - SERIT - 24 - TOP;                     // topun ALTI raketin üstüne değdiği an
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#14532D" }}>
      <View style={st.header}>
        <TouchableOpacity onPress={() => { canliRef.current = false; onBack(); }} style={{ paddingRight: 8 }}><Ionicons name={BACK_ICON} size={24} color="#fff" /></TouchableOpacity>
