          ...
          <View>
            ...
            {kind === "oyuncu" && (
              <TouchableOpacity onPress={onOpenShowcase} activeOpacity={0.85}
                style={{ backgroundColor: C.isDark ? "#12283A" : "#EAF3FB", borderWidth: 1.5, borderColor: "#2563EB", borderRadius: 16, padding: 13, gap: 3, marginBottom: 12 }}>
                <Text style={{ fontSize: 22 }}>🎽</Text>
                <Text style={{ fontSize: 14, fontWeight: "900", color: C.isDark ? "#7EB3F0" : "#1D4ED8" }}>{t("Oyuncuyum, takım arıyorum")}</Text>
