...
export default function SearchScreen({ onSearchUsers, onSearchEvents, suggestions = [], recent = [], onAddRecent, onOpenUser, onOpenEvent, posts = [], onLikePost = () => {}, onDeletePost = null, onCompose = () => {}, onOfferPost = null, onCommentsPost = null, onEditPost = null, onArchivePost = null }) {
            ...
            <View>
              ...
              {segment === "kisiler" && (
                <View style={{ marginTop: recent.length || suggestions.length ? 18 : 0 }}>
                  ...
                  {(() => { const gp = posts.filter((p) => postFiltre === "hepsi" ? true : postFiltre === "vitrin" ? !!p.listing : !p.listing); return gp.length === 0 ? (
                    <View style={st.hint}>
