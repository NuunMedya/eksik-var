...
import MarketSheet from "./screens/MarketSheet";
        ...
        <View style={{ flex: 1, backgroundColor: C.chalk }}>
          ...
          {tab === "profile" && view.name !== "settings" && (
            <ProfileScreen
              ...
              onEditListing={() => setMarketSheet(true)}
              ...
              marketMine={myListing} onMarket={() => setMarketSheet(true)}
          ...
          <MarketSheet visible={marketSheet} onClose={() => setMarketSheet(false)} initial={myListing}
        onSave={saveListing} onCloseListing={dropListing} />
      <Toast text={toast} />
