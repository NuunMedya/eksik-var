          ...
          kind === "oyuncu" && upcomingMine.length > 0 ? (
            ...
            {kind === "oyuncu" && (
              <TouchableOpacity onPress={() => setKind("pazar")} activeOpacity={0.85}
                style={{ flexDirection: "row", alignItems: "center", gap: 10, backgroundColor: C.surface, borderWidth: 1.5, borderColor: C.line, borderRadius: 16, padding: 13, marginBottom: 14, marginTop: -4 }}>
                <Text style={{ fontSize: 20 }}>🔁</Text>
                <View style={{ flex: 1 }}>
                  <Text style={{ fontSize: 14, fontWeight: "900", color: C.ink }}>{t("Transfer Pazarı")}</Text>
