...
export async function listEvents(meId, cityId) {
  ...
  const ctx = { meId, joinedIds, attendance, fill, waitCount, myWait, waitlists, availability, mvp, payments, guests };
...
/* ---------- sohbetler ---------- */
const CHAT_COLS = "id, type, event_id, series_id, name, created_at, conversation_members(user_id, role, last_read_message_id, users(" + USER_COLS + ")), messages(id, sender_id, type, content, created_at, poll_id, users(full_name))";
