...
grant select (id, full_name, username, bio, skill_level, avatar_url, positions, fav_cat, fav_cats, team_name,
...
grant update (full_name, username, bio, skill_level, avatar_url, positions, fav_cat, fav_cats, team_name,
