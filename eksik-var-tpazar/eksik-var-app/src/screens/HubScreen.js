...
const KARELER = [
  { key: "create",    emoji: "⚡", title: "Maç Kur" },
  { key: "pazar",     emoji: "🔁", title: "Transfer" },
  { key: "rakip",     emoji: "🆚", title: "Rakip Bul" },
  { key: "teklifler", emoji: "💌", title: "Teklifler" },
  { key: "kesfet",    emoji: "🧭", title: "Keşfet" },
  { key: "kadro",     emoji: "📋", title: "Kadro Dene" },
];
const OYUNLAR = [
        ...
        <View style={st.kareIzgara}>
          {KARELER.map((k) => (
            <TouchableOpacity key={k.key} onPress={() => onGo(k.key)} activeOpacity={0.85} style={st.kare}>
              <Text style={{ fontSize: 26 }}>{k.emoji}</Text>
