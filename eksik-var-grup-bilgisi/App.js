...
import { SEED_EVENTS, SEED_CHATS, SEED_APPS, ORGS, DEFAULT_SETTINGS, contactRules, genMembers, memberFromOrg, nowTime, uid } from "./src/data";
...
export default function App() {
  ...
  const hideTabs = view.name === "chat" || view.name === "create" || view.name === "settings" || view.name === "groupInfo" || !!activeEvent || !!call;
