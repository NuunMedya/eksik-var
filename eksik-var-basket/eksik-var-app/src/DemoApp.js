...
export default function DemoApp() {
  ...
  const hideTabs = ["chat", "create", "settings", "groupInfo", "attendance", "notifications", "rate", "blocked", "profile", "lineup", "editProfile", "penalti", "kadroDene", "basket"].includes(view.name);
  const ustEkran = ["hub", "penalti", "kadroDene", "basket"].includes(view.name) || !!activeEvent || !!call;
