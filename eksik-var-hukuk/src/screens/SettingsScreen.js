...
import { View, Text, TouchableOpacity, ScrollView, Switch, Alert, Linking, StyleSheet } from "react-native";
...
export default function SettingsScreen({ settings, onChange, onBack, onDeleteAccount }) {
      ...
      <ScrollView contentContainerStyle={{ padding: 18, paddingBottom: 60 }}>
        ...
        <View style={st.card}>
          ...
          <View style={[st.row, { borderTopWidth: 1, borderTopColor: C.line }]}>
            ...
            <Text style={{ fontSize: 12, fontWeight: "800", color: C.faint }}>0 kişi</Text>
          </View>
        </View>
