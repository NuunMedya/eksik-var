    ...
    >
      ...
      <ScrollView contentContainerStyle={{ padding: 18, paddingBottom: 120 }} keyboardShouldPersistTaps="handled">
            ...
            <Field label={t("Saha")}>
              ...
              {f.venueMode !== "sizde" && (
                <View style={{ marginTop: 8 }}>
                  <Input placeholder={f.venueMode === "bizde" ? "Saha adı, örn: Arena Spor Tesisleri" : "Önerdiğiniz saha (isteğe bağlı)"} value={f.venue} onChangeText={set("venue")} maxLength={80} />
                </View>
              )}
            </Field>
            <Field label={t("Ücret")}>
        ...
        <Field label={t("Saha / mekan")}>
          ...
          <Input placeholder={t("Örn: Yıldız Halı Saha, Çankaya")} value={f.venue} onChangeText={set("venue")} maxLength={80} />
        </Field>
        )}
