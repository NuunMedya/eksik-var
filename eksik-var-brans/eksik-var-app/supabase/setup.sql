...
begin
  ...
  insert into public.users (id, full_name, username, city_id, district_id, is_verified, fav_cat, positions)
  values (
...
grant select (id, full_name, username, bio, skill_level, avatar_url, positions, fav_cat, team_name,
...
grant update (full_name, username, bio, skill_level, avatar_url, positions, fav_cat, team_name,
